...
type GreetEveroneRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetEveroneRequest) Reset() {
	*x = GreetEveroneRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetEveroneRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetEveroneRequest) ProtoMessage() {}

func (x *GreetEveroneRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetEveroneRequest.ProtoReflect.Descriptor instead.
func (*GreetEveroneRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{7}
}

func (x *GreetEveroneRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
type GreetEveroneResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetEveroneResponse) Reset() {
	*x = GreetEveroneResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetEveroneResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetEveroneResponse) ProtoMessage() {}

func (x *GreetEveroneResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetEveroneResponse.ProtoReflect.Descriptor instead.
func (*GreetEveroneResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{8}
}

func (x *GreetEveroneResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x42, 0x0a, 0x13, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45,
	0x76, 0x65, 0x72, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2b, 0x0a,
	...
	0x52, 0x08, 0x67, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x2e, 0x0a, 0x14, 0x47, 0x72,
	0x65, 0x65, 0x74, 0x45, 0x76, 0x65, 0x72, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x65, 0x12, 0x1a, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45,
	0x76, 0x65, 0x72, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e,
	0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45, 0x76, 0x65, 0x72, 0x6f,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GreetEveroneRequest)(nil),       // 7: greet.GreetEveroneRequest
	(*GreetEveroneResponse)(nil),      // 8: greet.GreetEveroneResponse
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0,  // 3: greet.GreetEveroneRequest.greeting:type_name -> greet.Greeting
	...
	7,  // 9: greet.GreetService.GreetEveryone:input_type -> greet.GreetEveroneRequest
	...
	8,  // 14: greet.GreetService.GreetEveryone:output_type -> greet.GreetEveroneResponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetEveroneRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greet_greetpb_greet_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetEveroneResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GreetService_GreetEveryoneClient interface {
	Send(*GreetEveroneRequest) error
	Recv() (*GreetEveroneResponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetEveryoneClient) Send(m *GreetEveroneRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneClient) Recv() (*GreetEveroneResponse, error) {
	m := new(GreetEveroneResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetService_GreetEveryoneServer interface {
	Send(*GreetEveroneResponse) error
	Recv() (*GreetEveroneRequest, error)
	grpc.ServerStream
}
...
func (x *greetServiceGreetEveryoneServer) Send(m *GreetEveroneResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneServer) Recv() (*GreetEveroneRequest, error) {
	m := new(GreetEveroneRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
